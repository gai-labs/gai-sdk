...
def test_file_dialogue_add_and_list_messages(request):
    ...
    umsg2 = dialogue.add_user_message(
        recipient='Diana',
...
def test_file_dialogue_batch_messages(request):
    ...
    assert loaded[0].body.content == 'Please introduce yourselves. Sara, it is your turn.'
    assert loaded[1].body.content == 'Hi there! I am Sara, your AI assistant. I am here to help you with any questions or tasks you have.'
    assert loaded[2].body.content == 'Please introduce yourselves. Diana, it is your turn.'
    assert loaded[3].body.content == 'Hello! I am Diana, another AI assistant. I can assist you with various tasks and provide information on a wide range of topics.'