...
from mock_data.mock_openai_patch import chat_completions_generate, chat_completions_stream, chat_completions_toolcall, chat_completions_streaming_toolcall, chat_completions_jsonschema
...
def test_patch_anthropic_streaming_toolcall_Anthropic_API(mock_messages_prop):
    ...
    mock_messages = MagicMock()
    mock_messages.create.return_value = chat_completions_streaming_toolcall(
        "anthropic")
    mock_messages_prop.return_value = mock_messages
